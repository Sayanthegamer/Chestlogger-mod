...
|---|---|---|---|
| **Fabric 26.2 Mod** | `chestlogger-fabric-2.6.0.jar` | `:chestlogger-fabric` | Fabric Loader 0.19.3+, Fabric API, Java 25 |
| **Paper 26.2 Plugin** | `chestlogger-paper-2.6.0.jar` | `:chestlogger-paper` | Paper 26.2 Server, Java 25 |
...
ChestLogger 2.6.0 features an intelligent, context-aware anti-theft and raid detection engine that distinguishes legitimate cooperative gameplay from malicious griefing and looting in sub-20ms latency.
...
1. Download `chestlogger-fabric-2.6.0.jar` from [**Releases**](https://github.com/Sayanthegamer/Chestlogger-mod/releases).
2. Place into your server or client `mods/` directory.
3. Requires Fabric API for 26.2.

### Paper Server
1. Download `chestlogger-paper-2.6.0.jar` from [**Releases**](https://github.com/Sayanthegamer/Chestlogger-mod/releases).
...
- `chestlogger-fabric/build/libs/chestlogger-fabric-2.6.0.jar` (Fabric Mod)
- `chestlogger-paper/build/libs/chestlogger-paper-2.6.0.jar` (Paper Plugin)
