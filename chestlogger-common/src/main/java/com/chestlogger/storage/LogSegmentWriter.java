...
public final class LogSegmentWriter implements Closeable {
    ...
    public LogSegmentWriter(
        ...
        ThreadGuard.assertNotServerThread("LogSegmentWriter.<init>");
    ...
    private void openNextSegment() throws IOException {
        ThreadGuard.assertNotServerThread("LogSegmentWriter.openNextSegment");
        if (currentFos != null) {
    ...
    public synchronized void flushDictionaryBlock() throws IOException {
        ThreadGuard.assertNotServerThread("LogSegmentWriter.flushDictionaryBlock");
    ...
    public synchronized int writeBatch(List<TransactionLogEntry> records) throws IOException {
        ThreadGuard.assertNotServerThread("LogSegmentWriter.writeBatch");
    ...
    public synchronized void close() throws IOException {
        ThreadGuard.assertNotServerThread("LogSegmentWriter.close");
        if (currentFos != null) {
            flushDictionaryBlock();
            currentFos.flush();
            if (profile.forceFsync()) {
