...
public final class HttpAuthValidator {
    ...
    /**
     * Validates an incoming HTTP request for authentication, CORS compliance, and rate limiting.
     *
     * @param exchange the HTTP exchange
     * @param config the web configuration
     * @return true if the request is authenticated and should proceed, false if handled/rejected
