...
class GuiClientServerIntegrationTest {
    ...
    void testQuerySessionInitializationFromTransactionRecords() {
        ...
        ChestLogPagePayload initialPayload = sessionManager.createSession(
    ...
    void testClientPaginationRequestsAndBoundedSlicing() {
        ...
        ChestLogPagePayload emptyPayload = sessionManager.createSession(
        ...
        ChestLogPagePayload emptyClamped = sessionManager.getPage(emptyQueryId, 10);
    ...
    void testSessionExpirationAndReQuerying() {
        ...
        ChestLogPagePayload payload1 = sessionManager.createSession(
        ...
        if (!sessionManager.hasSession(clientRequest.queryId())) {
            ...
            requeryResponse = sessionManager.createSession(
            ...
            requeryResponse = sessionManager.getPage(clientRequest.queryId(), clientRequest.requestedPage());
        }
        ...
        assertThat(sessionManager.hasSession(queryId)).isTrue();
        ChestLogPagePayload cachedPage1 = sessionManager.getPage(queryId, 1);
    ...
    void testEndToEndDiskToSessionPayloadPipeline(@TempDir Path tempDir) throws IOException {
        ...
        UUID queryId = UUID.randomUUID();
        ChestLogPagePayload page1 = sessionManager.createSession(
    ...
    private ChestLogPagePayload simulateClientServerRoundTrip(ChestLogPageRequestPayload request) {
        ...
        ChestLogPagePayload serverResponse = sessionManager.getPage(
    ...
    private ChestLogPagePayload processServerFilterRequest(
        ...
        // Matches exact filtering logic in ChestLogNetworking.init() receiver
